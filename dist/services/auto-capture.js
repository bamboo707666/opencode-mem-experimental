...
function classifyMemoryClass(userPrompt, textResponses, toolCalls) {
    ...
    const scores = { handoff: handoffScore, postmortem: postmortemScore, operational_preference: prefScore };
    ...
    return { class: bestClass, confidence };
}
